...
import com.cloudhub.normal.service.CopyMoveService;
import com.cloudhub.normal.service.validator.FileOperateValidator;
...
public class CopyMoveServiceImpl implements CopyMoveService {
    ...
    @Override
    public ResponseEntity<String> batchMove(String pairList, String distId) {
        //参数解析
        long l_distId = Long.parseLong(distId);
        List<MiniInfo> list = JSON.parseObject(pairList, List.class);
        //初始化回复信息体
