package com.cloudhub.web.controller;

import com.cloudhub.model.FileAttribute;
import com.cloudhub.service.FileHandlerService;
import com.cloudhub.service.FilePreview;
import com.cloudhub.service.FilePreviewFactory;
import com.cloudhub.service.cache.CacheService;
import com.cloudhub.service.impl.OtherFilePreviewImpl;
import com.cloudhub.utils.KkFileUtils;
import com.cloudhub.utils.WebUtils;
...
import static com.cloudhub.service.FilePreview.PICTURE_FILE_PREVIEW_PAGE;
...
public class OnlinePreviewController {
    ...
    public String directOnlinePreview(String exposedUrl, Model model, HttpServletRequest req){
        FileAttribute fileAttribute = fileHandlerService.getFileAttribute(exposedUrl, req);
        model.addAttribute("file", fileAttribute);
        FilePreview filePreview = previewFactory.get(fileAttribute);
        logger.info("预览文件url：{}，previewType：{}", exposedUrl, fileAttribute.getType());
        return filePreview.filePreviewHandle(exposedUrl,model, fileAttribute);
    }
